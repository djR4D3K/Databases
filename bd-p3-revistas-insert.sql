-- fichero bd-p3-revistas-insert.sql
---------------------------------------------------------------------------------
...
** Mas informacion en el enunciado de la practica P3. DMD.                  **
******************************************************************************/
...
ALTER TABLE REVISTA DISABLE CONSTRAINT revista_fk_pcontratado;
DELETE FROM PERIODISTA_CONTRATADO;
DELETE FROM REVISTA;
ALTER TABLE REVISTA ENABLE CONSTRAINT revista_fk_pcontratado;
